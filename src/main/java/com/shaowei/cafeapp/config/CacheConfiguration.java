package com.shaowei.cafeapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.shaowei.cafeapp.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.shaowei.cafeapp.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
